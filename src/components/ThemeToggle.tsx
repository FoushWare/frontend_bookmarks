...
export function ThemeToggle() {
  ...
  const icons = {
    ...
    system: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="right">
      ...
      {options.map((opt) => (
        <button
          ...
          style={{
            ...
            background: activePref === opt ? 'var(--text)' 
              : 'transparent',
            color: activePref === opt ? 'var(--bg)' 
              : 'var(--text-muted)',
          }}
